...
{
    partial class DebugSyntaxLexerSimulator
    {
        ...
        #region MoonScript
        private partial global::SamLu.CodeAnalysis.MoonScript.Syntax.InternalSyntax.Lexer CreateMoonScriptLexer(global::Microsoft.CodeAnalysis.Text.SourceText text);
        private partial global::SamLu.CodeAnalysis.MoonScript.Syntax.InternalSyntax.SyntaxToken LexNode(global::SamLu.CodeAnalysis.MoonScript.Syntax.InternalSyntax.Lexer lexer);
        private partial global::System.Collections.Generic.IEnumerable<global::Microsoft.CodeAnalysis.SyntaxToken> DescendTokens(global::SamLu.CodeAnalysis.MoonScript.Syntax.InternalSyntax.SyntaxToken node);
        ...
        global::Luna.Compilers.Simulators.TokenKind global::Luna.Compilers.Simulators.ILexerSimulator.GetTokenKind(int rawKind)
        {
            switch(this._context.LanguageName)
            {
                ...
                case "MoonScript": return this.GetTokenKind((global::SamLu.CodeAnalysis.MoonScript.SyntaxKind)rawKind);
        ...
        global::System.Collections.Generic.IEnumerable<global::Microsoft.CodeAnalysis.SyntaxToken> global::Luna.Compilers.Simulators.ILexerSimulator.LexToEnd(global::Microsoft.CodeAnalysis.Text.SourceText text)
        {
            switch(this._context.LanguageName)
            {
                ...
                case "MoonScript":
                {
                    var lexer = this.CreateMoonScriptLexer(text);
                    global::SamLu.CodeAnalysis.MoonScript.Syntax.InternalSyntax.SyntaxToken node;
                    do
                    {
                        node = this.LexNode(lexer);
                        foreach (var token in this.DescendTokens(node)) yield return token;
                    }
                    while (node.Kind != global::SamLu.CodeAnalysis.MoonScript.SyntaxKind.EndOfFileToken);
                    break;
                }
                default: throw new InvalidOperationException("意外的语言名称：" + this._context.LanguageName);
            }
