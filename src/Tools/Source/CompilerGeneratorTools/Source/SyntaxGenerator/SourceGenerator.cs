...
public abstract class SourceGenerator : CachingSourceGenerator
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        addResult(writer => this.CreateSourceWriter(writer, tree, cancellationToken).WriteMain(), "Syntax.xml.Main.Generated.cs");
        addResult(writer => this.CreateSourceWriter(writer, tree, cancellationToken).WriteInternal(), "Syntax.xml.Internal.Generated.cs");
        addResult(writer => this.CreateSourceWriter(writer, tree, cancellationToken).WriteSyntax(), "Syntax.xml.Syntax.Generated.cs");
    ...
    private protected abstract SourceWriter CreateSourceWriter(TextWriter writer, Tree tree, CancellationToken cancellationToken);
